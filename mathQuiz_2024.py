...
print ("***\nEnter answers as whole numbers (quotient for division). \nTo end the quiz, type 'end'.\n***")
...
while True: #   'while True' loop allows a block of code to be repeated indefinitely.
	...
	wrong = ["Oops. Try again.", "No...", f"That's not {ans}.", f"That's not {ans}.", f"How don't you know that it's {ans}?", "Monkey see, monkey cannot do.", f"Time for {name}'s nap."]
